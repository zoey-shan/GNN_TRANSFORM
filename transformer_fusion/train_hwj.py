...
from tcn_transformer import TcnTransformer
import torch
...
parser.add_argument('-g',
                    ...
                    nargs='+',
                    type=int,
                    help='index of gpu to use, default 2')
...
parser.add_argument('--sgdstep',
                    default=5,
                    type=int,
                    help='number of steps to adjust lr for sgd, default 5')
parser.add_argument('--sgdgamma',
                    default=0.1,
                    type=float,
                    help='gamma of steps to adjust lr for sgd, default 0.1')

parser.add_argument('--annotation',
                    default='annotation_train.txt',
                    type=str,
                    help='annotation path')
parser.add_argument('--video',
                    default='F:/Feature/MISAW_train/Video/',
                    type=str,
                    help='Video path')
parser.add_argument('--image',
                    default='F:/Feature/MISAW_train/Images/',
                    type=str,
                    help='Video to images save path')
parser.add_argument('--data',
                    default='F:/Feature/MISAW_train/Kinematic/',
                    type=str,
                    help='Video to kdata save path')
